...
export const GERMAN_HEALTH_INSURANCES = [
  ...
  { name: "BMW BKK", additionalRate: 2.52 },
  { name: "BKK Akzo Nobel", additionalRate: 3.39 },
  { name: "BKK B. Braun Aesculap", additionalRate: 2.95 },
  { name: "Bergische Krankenkasse", additionalRate: 2.95 },
  { name: "Bertelsmann BKK", additionalRate: 3.20 },
  { name: "Betriebskrankenkasse der G. M. Pfaff AG", additionalRate: 2.78 },
  { name: "Betriebskrankenkasse Schwarzwald‑Baar‑Heuberg", additionalRate: 2.44 },
  { name: "Betriebskrankenkasse Vereinigte Deutsche Nickel‑Werke (BKK VDN)", additionalRate: 3.19 },
  ...
  { name: "BKK Miele", additionalRate: 2.80 },
  ...
  { name: "IKK Südwest", additionalRate: 3.25 },
  { name: "IKK – Die Innovationskasse", additionalRate: 4.30 },
  { name: "Innungskrankenkasse Brandenburg und Berlin (IKK BBB)", additionalRate: 4.35 },
  ...
  { name: "R+V Betriebskrankenkasse", additionalRate: 2.96 },
  { name: "Salus BKK", additionalRate: 2.99 },
  { name: "SBK (Siemens‑BKK)", additionalRate: 3.80 },
  { name: "Securvita BKK", additionalRate: 3.90 },
